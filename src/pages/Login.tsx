  ...
  return (
    <div className="relative flex min-h-screen w-full font-mono bg-slate-900 overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('https://images.squarespace-cdn.com/content/v1/60538c08a71fdc089bd4e783/1617815287266-6LJHNQ8QB8TYCOV34OMC/HR-team.jpeg')`
        }}
      />
      ...
      <div className="relative z-10 flex w-full min-h-screen">
        ...
        <div className="hidden w-1/2 flex-col justify-between bg-[#111f42]/40 p-12 lg:flex backdrop-blur-sm border-r border-white/10">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4 text-white mb-16 cursor-pointer group">
              <div className="relative flex h-16 w-16 items-center justify-center transition-transform duration-500 group-hover:scale-105 drop-shadow-[0_4px_12px_rgba(0,0,0,0.4)]">
                <RecoloredLogo className="w-full h-full" />
              </div>
            ...
            >
              <h1 className="text-[75px] font-exception-prompt tracking-widest text-white leading-none mb-4 shadow-black/20 drop-shadow-xl">
                SMART HR V1.0
              </h1>
              <h2 className="text-[26px] font-bold text-white mb-8 tracking-wide drop-shadow-md">
                Intelligent Human Resource Hub
              </h2>
              <p className="max-w-md text-[15px] leading-relaxed text-white/80 font-medium">
                Streamline the management of human resources,<br />
                ensure seamless employee tracking, and centralize<br />
                all your operations required for HR processes.<br />
              </p>
          ...
          <div className="flex w-full items-end justify-between mt-auto">
            ...
            <div className="flex items-center gap-4 rounded-3xl border border-white/20 bg-[#2a2d45]/40 backdrop-blur-md p-4 shadow-2xl">
              ...
              <div className="flex flex-col pr-2">
                <span className="text-[14px] font-bold text-white tracking-wide">HR SYSTEM Developer</span>
        ...
        <div className="flex w-full items-center justify-center p-6 lg:w-1/2">
          <motion.div 
            ...
            className="w-full max-w-[360px] rounded-[16px] bg-white/50 backdrop-blur-xl border-2 border-white/60 p-4 sm:p-4 shadow-[0_30px_60px_rgba(0,0,0,0.15)]"
          >
            <div className="mb-2">
              <div className="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-[#E3624A] text-white mb-2 lg:hidden shadow-lg">
                <Shield size={16} strokeWidth={2.5} />
              </div>
              <h2 className="text-[22px] font-bold text-[#1a2035] tracking-wide">
                Welcome back
              </h2>
              <p className="text-[12px] font-medium text-[#4a5568] leading-snug pr-4 mt-0.5">
            ...
            <form className="space-y-0" onSubmit={handleSubmit}>
              <div className="space-y-2">
                <div>
                  <label className="block text-[12px] font-bold text-[#1a2035] mb-1.5">
                    Staff Code
                  </label>
                  <div className="relative group">
                    ...
                    <input
                      type="text"
                      required
                      className="block w-full bg-white/40 border border-white/60 rounded-xl py-2 pl-10 pr-4 text-[13px] font-bold text-slate-800 placeholder:text-slate-500/60 focus:bg-white/70 focus:border-white focus:ring-2 focus:ring-white/50 outline-none transition-all shadow-inner"
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      required
                      className="block w-full bg-white/40 border border-white/60 rounded-xl py-2 pl-10 pr-10 text-[13px] font-bold text-slate-800 placeholder:text-slate-500/60 focus:bg-white/70 focus:border-white focus:ring-2 focus:ring-white/50 outline-none transition-all shadow-inner"
              ...
              <button
                ...
                className="w-full bg-[#111f42] text-white mt-4 py-2.5 px-6 rounded-[10px] text-[13px] font-bold flex items-center justify-center gap-3 shadow-xl hover:bg-[#111f42]/90 transition-all disabled:opacity-70 group"
              >
                {isLoading ? (
              ...
              <button
                ...
                disabled={isLoading || isGoogleLoading}
                className="gsi-material-button w-full flex items-center justify-center py-2 px-6 mt-3 rounded-[10px] border border-slate-300 bg-white hover:bg-slate-50 transition-all disabled:opacity-70 shadow-sm"
              >
                {isGoogleLoading ? (
              ...
              <div className="mt-3 rounded-[10px] bg-white/60 p-2 text-center shadow-inner border border-white/60 backdrop-blur-sm">
                <div className="font-bold text-[#1a2035] text-[11px] mb-1">Demo Credentials</div>
                <div className="text-[11px] font-semibold text-slate-700">User: DEMO / Pass: DEMO123456789</div>
              </div>
            </form>
          </motion.div>
        </div>
