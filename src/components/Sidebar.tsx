...
const CATEGORIES: Record<string, string> = {
  'CORE HR & OPERATIONS': 'การปฏิบัติการทรัพยากรบุคคล',
  'RECRUITMENT': 'การสรรหาบุคลากร',
  'PERFORMANCE & DEVELOPMENT': 'การประเมินและพัฒนาบุคลากร',
          ...
          {!isCollapsed && (
            <div className="flex flex-col">
              <div className="flex items-center gap-[4px] text-[24px] font-black tracking-tighter font-exception-system transform scale-x-105 origin-left leading-none" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}>
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#899fbc] to-[#ccd3e0]">HR</span>
              </div>
              <div className="flex items-center mt-2 group" style={{ fontFamily: "'Inter', sans-serif" }}>
                <div className="w-3 h-[2px] bg-gradient-to-r from-[#899fbc] to-transparent mr-2" />
                <span className="text-[9px] font-bold text-[#7a8b95] group-hover:text-[#899fbc] transition-colors tracking-[0.2em] uppercase leading-none drop-shadow-md">
                  {t('HUMAN CAPITAL MANAGEMENT', 'การจัดการทุนมนุษย์')}
                </span>
              </div>
            </div>
          )}
            ...
            return (
              <NavLink
                ...
                className={twMerge(clsx(
                  ...
                  active
                    ? "bg-gradient-to-r from-[#1e3347] via-[#405974] to-[#899fbc] text-white shadow-md shadow-[#1e3347]/20" 
          ...
          <div className={clsx("flex items-center justify-between", isCollapsed ? "justify-center" : "gap-3")}>
            <div className="flex items-center gap-3 overflow-hidden">
              {user.avatar ? (
                ...
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-[#1e3347] to-[#899fbc] text-white font-black uppercase text-[16px]">
                  {user.name.charAt(0)}
                </div>
              )}
              {!isCollapsed && (
